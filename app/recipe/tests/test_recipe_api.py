...
class PublicRecipeAPITests(TestCase):
    """Test unauthenticated API clients."""
...
class PrivaterecipeApiTests(TestCase):
    ...
    def test_create_api_with_new_ingredients(self):
    ...
    def test_crate_recipe_with_existing_ingredients(self):
    ...
    def test_create_ingredient_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(user=self.user, names='Limes')
